...
//                tList.add(new Task(1+r.nextInt(2), 32, 2, 1690, taskID++, 0.1));
                task = new Task(Variable.Pareto_Distribution(), 32, 2, 1690,
...
//                tList.add(new Task(1+r.nextInt(3), 30, 2, 420, taskID++,0.2));
                task = new Task(Variable.Pareto_Distribution(),30, 2, 420,
                        taskID++,LenLower+r.nextInt(LenUpper));
                tList.add(task);
                task.setArrivalTime(sum);
...
//                tList.add(new Task(1+r.nextInt(4), 7, 2, 1690, taskID++,0.3));
                task = new Task(Variable.Pareto_Distribution(), 7, 2, 1690,
                        taskID++,LenLower+r.nextInt(LenUpper));
                tList.add(task);
                task.setArrivalTime(sum);
